    ...
    <Layout>
      <SideMenu>
        ...
        <div className="flex flex-col mt-5 gap-3">
          <a
            className="p-1 flex bg-white items-center font-semibold text-blue-700 hover:text-blue-900 hover:bg-gray-200 cursor-pointer"
            onClick={navigateHome}
          >
            Overview
          </a>
      ...
      <MainBoard>
        <div className="m-5">
          <div className="container mx-auto px-4 m-4 rounded-md bg-white">
            <h2 className="p-3 text-xl font-semibold border-b border-gray-200">
